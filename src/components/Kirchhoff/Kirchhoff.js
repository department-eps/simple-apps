    ...
    return (
        <Container maxWidth={'lg'} sx={{ paddingTop: '90px' }}>
            <Grid container sx={{ justifyContent: 'center', alignItems: 'center' }}>
                ...
                <Grid item xs={12} md={12} lg={12} sx={{ textAlign: 'left', paddingTop: '35px' }}>
                    <Typography variant='h5'>&emsp;Въведете мощностите на товарите във всеки възел. При това ще видите как се променят мощностите във всеки клон на мрежата съгласно I-ви закон на Кирхоф.</Typography>
